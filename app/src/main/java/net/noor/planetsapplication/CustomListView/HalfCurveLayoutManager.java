 ...
 */
package net.noor.planetsapplication.CustomListView;
...
public class HalfCurveLayoutManager extends CenterEdgeItemsRecyclerView.ChildLayoutManager {
    ...
    public void updateChild(View child, CenterEdgeItemsRecyclerView parent) {
        ...
        //ToDo: change circle raduis
        this.setUpCircularInitialLayout((this.mLayoutWidth * 5) - (this.mLayoutWidth / 5), this.mLayoutHeight);
